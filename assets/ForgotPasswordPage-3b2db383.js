import{v as c,s,k as x,o as d,j as a,F as p,m as l,B as h,_ as i,C as g,H as u}from"./index-f816ea25.js";import{S as w,H as b,a as j}from"./SignInPage.styled-bcb0e15c.js";import{S as y,f}from"./SignInForm.styled-e9a5dbe7.js";import{F,I as S,B as k,T as $}from"./SignUpImage.styled-ea4f2c5c.js";import{w as T,a as v,b as D,c as M,d as B,e as I}from"./watch-desk@2x-74011178.js";const P=c.create({baseURL:"https://healthy-way-app.onrender.com"}),E=async o=>{try{const{data:e}=await P.post("/api/auth/forgot-password",o);return e}catch(e){throw e.response.data}},H=s(x)`
  position: absolute;
  top: 30px;
  left: 10px;
`,W=s(y)`
