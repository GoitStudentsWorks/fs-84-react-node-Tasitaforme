import{v as c,s,k as x,o as d,j as a,F as p,m as l,B as h,_ as i,C as g,H as u}from"./index-b3078306.js";import{S as w,H as b,a as j}from"./SignInPage.styled-45c30fd6.js";import{S as y,f}from"./SignInForm.styled-9e6f6779.js";import{F,I as S,B as k,T as $}from"./SignUpImage.styled-58816b3f.js";import{w as T,a as v,b as D,c as M,d as B,e as I}from"./watch-desk@2x-74011178.js";const P=c.create({baseURL:"https://healthy-way-app.onrender.com"}),E=async o=>{try{const{data:e}=await P.post("/api/auth/forgot-password",o);return e}catch(e){throw e.response.data}},H=s(x)`
  position: absolute;
  top: 30px;
  left: 10px;
`,W=s(y)`
